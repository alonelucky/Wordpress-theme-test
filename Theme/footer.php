		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							Copyright &copy; 2016.Company <a target="_blank" href="<?php echo get_option('home');?>">自制主题实战</a>
						</p>
					</div>
				</div>
				<div class="col-lg-6">
...
<!-- Vendor Scripts -->
<script src="<?php bloginfo('stylesheet_directory');?>/js/modernizr.custom.js"></script>
...
<script src="<?php bloginfo('stylesheet_directory');?>/js/owl-carousel/owl.carousel.js"></script>
</body>
</html>